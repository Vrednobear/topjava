...
//        mealsTo.forEach(System.out::println);
    ...
    public static List<MealTo> getFilteredWithExcessParameter(List<Meal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<MealTo> getMealsWithExcessParameter(List<Meal> meals, int CALORIES_PER_DAY) {
